...
export default ({
  state: {
    ...
    otuItems: [
      {
        header: 'Подъемно-транспортное оборудование',
        name: 'ПТО',
        items: {
      ...
      {
        header: 'Газовое оборудование',
        name: 'ГО',
        items: {
          1: 'Трубопроводы систем внутреннего газоснабжения',
          2: 'Наружные газопроводы низкого, среднего и высокого давления стальные',
          '2п': 'Наружные газопроводы низкого, среднего и высокого давления из неметаллических материалов',
      ...
      {
        header: 'Нефтегазодобывающее оборудование',
        name: 'НГДО',
        items: {
          1: 'Пром. и магистр. нефтепродуктопроводы, трубопроводы НПС, обеспечивающие тран. нефти и нефтепродуктов при сооружении, реконструкции и капитальном ремонте',
          2: 'Пром. и магистр. нефтепродуктопроводы, трубопроводы НПС, обеспечивающие тран. нефти и нефтепродуктов при текущем ремонте в процессе эксплуатации',
          3: 'Промысловые и магистральные газопроводы и конденсатопроводы; трубопроводы для транспортировки товарной продукции, импульсного, топливного и пускового газа в пределах: установок комплексной подготовки газа (УКПГ), компрессорных станций (КС), и др',
      ...
      {
        header: 'Металлургическое оборудование',
        name: 'МО',
        items: {
      ...
      {
        header: 'Оборудование химических, нефтехимических, нефтеперерабатывающих и взрывопожароопасных производств',
        name: 'ОХНВП',
        items: {
      ...
      {
        header: 'Горнодобывающее оборудование',
        name: 'ГДО',
        items: {
      ...
      {
        header: 'Строительные конструкции',
        name: 'СК',
        items: {
